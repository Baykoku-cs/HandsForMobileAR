...
public class TubeDrawer : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        _poseDetectBus.SubscribeOnPoseDetected(EventType.OnPoseDetected, PoseType.Pointing_Up, OnPointUpDetected);
        _poseDetectBus.SubscribeOnPoseDetected(EventType.OnPoseDetected, PoseType.Closed_Fist, OnFistDetected);
        _poseDetectBus.SubscribeOnPoseDetected(EventType.OnPoseDetected, PoseType.Thumb_Down, OnDislikeDetected);
        _poseDetectBus.SubscribeOnPoseDetected(EventType.OnPoseDetected, PoseType.Thumb_Up, OnLikeDetected);
    }
