...
namespace HandsForMobileAR
{
    namespace DrawerSample
    {
        public class ColorPicker : MonoBehaviour
        {
            ...
            private void Start()
            {
                _poseDetectBus.SubscribeOnPoseDetected(DefaultComponents.EventType.OnPoseDetected, DefaultPoseNames.Open_Palm.ToString(), SpawnDialog);
            }
            private void OnDestroy()
            {
                _poseDetectBus.UnSubscribeOnPoseDetected(DefaultComponents.EventType.OnPoseDetected, DefaultPoseNames.Open_Palm.ToString(), SpawnDialog);
            }
